...
<head>
  ...
  <script type="text/javascript" src="<?= $this->getUrl()->baseUrl('skin/js/jquery-3.6.0.js'); ?>"></script>
  <script type="text/javascript" src="<?= $this->getUrl()->baseUrl('skin/js/mage.js'); ?>"></script>
</head>
