<?php //echo '<pre>'; print_r($this->getCategoryOptions());?>
<?php //print_r($this->getCategory());?>
<?php  $category = \Mage::getBlock('Block_Admin_Category_Edit')->getCategory(); ?>
...
<body>
  ...
  <form class="form" method="POST" action='<?php echo $this->getUrl()->getUrl('Admin_category','save', ['id' => $category->category_id ]); ?>' >
    <table>
        ...
        <tr class="form-group">
            ...
            <td>
              ...
              <?php foreach ($category->getStatusOption() as $key => $value) : ?>
                <option value="<?php echo $key; if($category->status == 1): ?>" selected <?php endif; ?>><?php echo $value; ?></option>
              <?php endforeach; ?>
              </select>
            </td> 
  	    </tr>
        <tr class="form-group">
            ...
            <td>
              ...
              <?php foreach ($category->getFeaturedOption() as $key => $value) : ?>
                <option value="<?php echo $key; if($category->featured == 1): ?>" selected <?php endif; ?>><?php echo $value; ?></option>
              <?php endforeach; ?>
              </select>
            </td> 
  	    </tr>
